...
When using [Universal Render Pipeline](https://docs.unity3d.com/Assets/com.unity.render-pipelines.universal@latest/index.html) (URP) with the __2D Renderer__ selected, the __Light 2D__ component introduces a way to apply 2D optimized lighting to Sprites. 
