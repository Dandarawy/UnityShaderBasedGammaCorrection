...
#region Passes
        ShaderPass m_ForwardPass = new ShaderPass
        {
            ...
            passInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/PBRForwardPass.hlsl",
            varyingsInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/Varyings.hlsl",
            useInPreview = true,
            ...
            includes = new List<string>()
            {
                ...
                "Assets/com.unity.render-pipelines.universal/ShaderLibrary/Core.hlsl",
                "Assets/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl",
                "Assets/com.unity.render-pipelines.universal/ShaderLibrary/Shadows.hlsl",
                "Assets/com.unity.render-pipelines.universal/ShaderLibrary/ShaderGraphFunctions.hlsl",
                "Assets/com.unity.shadergraph/ShaderGraphLibrary/ShaderVariablesFunctions.hlsl"
            },
        ...
        ShaderPass m_DepthOnlyPass = new ShaderPass()
        {
            ...
            lightMode = "DepthOnly",
            passInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/DepthOnlyPass.hlsl",
            varyingsInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/Varyings.hlsl",
            useInPreview = true,
        ...
        ShaderPass m_ShadowCasterPass = new ShaderPass()
        {
            ...
            passInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/ShadowCasterPass.hlsl",
            varyingsInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/Varyings.hlsl",
        ...
        ShaderPass m_LitMetaPass = new ShaderPass()
        {
            ...
            lightMode = "Meta",
            passInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/LightingMetaPass.hlsl",
            varyingsInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/Varyings.hlsl",
            ...
            includes = new List<string>()
            {
                ...
                "Assets/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl",
                "Assets/com.unity.render-pipelines.universal/ShaderLibrary/ShaderGraphFunctions.hlsl",
                "Assets/com.unity.render-pipelines.universal/ShaderLibrary/MetaInput.hlsl",
                "Assets/com.unity.shadergraph/ShaderGraphLibrary/ShaderVariablesFunctions.hlsl"
            },
            pragmas = new List<string>()
            {
        ...
        ShaderPass m_2DPass = new ShaderPass()
        {
            ...
            passInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/PBR2DPass.hlsl",
            varyingsInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/Varyings.hlsl",
