...
#region Passes
        ShaderPass m_LitPass = new ShaderPass
        {
            ...
            passInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/SpriteLitPass.hlsl",
            ...
            includes = new List<string>()
            {
                ...
                "Assets/com.unity.render-pipelines.universal/Shaders/2D/Include/LightingUtility.hlsl",
            },
        ...
        ShaderPass m_NormalPass = new ShaderPass
        {
            ...
            passInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/SpriteNormalPass.hlsl",
            varyingsInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/Varyings.hlsl",
            useInPreview = true,
            ...
            includes = new List<string>()
            {
                ...
                "Assets/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl",
                "Assets/com.unity.render-pipelines.universal/ShaderLibrary/ShaderGraphFunctions.hlsl",
                "Assets/com.unity.render-pipelines.universal/Shaders/2D/Include/NormalsRenderingShared.hlsl"
            },
            pragmas = new List<string>()
            {
                "prefer_hlslcc gles",
        ...
        ShaderPass m_ForwardPass = new ShaderPass
        {
            ...
            passInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/SpriteForwardPass.hlsl",
            varyingsInclude = "Assets/com.unity.render-pipelines.universal/Editor/ShaderGraph/Includes/Varyings.hlsl",
            useInPreview = true,
