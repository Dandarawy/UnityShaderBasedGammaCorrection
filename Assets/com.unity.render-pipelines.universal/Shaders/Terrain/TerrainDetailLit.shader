Shader "Hidden/TerrainEngine/Details/UniversalPipeline/Vertexlit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/com.unity.render-pipelines.universal/ShaderLibrary/Core.hlsl"
            #include "Assets/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/com.unity.render-pipelines.universal/Shaders/UnlitInput.hlsl"
