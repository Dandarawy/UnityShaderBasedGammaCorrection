Shader "Hidden/Universal Render Pipeline/Terrain/Lit (Base Pass)"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/com.unity.render-pipelines.universal/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Assets/com.unity.render-pipelines.universal/Shaders/Terrain/TerrainLitPasses.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/com.unity.render-pipelines.universal/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Assets/com.unity.render-pipelines.universal/Shaders/Terrain/TerrainLitMetaPass.hlsl"
