...
Shader "Hidden/TerrainEngine/Details/UniversalPipeline/WavingDoublePass"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/com.unity.render-pipelines.universal/Shaders/Terrain/WavingGrassInput.hlsl"
            #include "Assets/com.unity.render-pipelines.universal/Shaders/Terrain/WavingGrassPasses.hlsl"
