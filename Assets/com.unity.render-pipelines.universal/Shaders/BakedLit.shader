Shader "Universal Render Pipeline/Baked Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/com.unity.render-pipelines.universal/Shaders/BakedLitInput.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/com.unity.render-pipelines.universal/Shaders/BakedLitInput.hlsl"
            #include "Assets/com.unity.render-pipelines.universal/Shaders/BakedLitMetaPass.hlsl"
