...
Shader "Universal Render Pipeline/Particles/Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/com.unity.render-pipelines.universal/Shaders/Particles/ParticlesLitInput.hlsl"
            #include "Assets/com.unity.render-pipelines.universal/Shaders/Particles/ParticlesLitForwardPass.hlsl"
            ENDHLSL
        }
        Pass
        {
